    ...
    <Box sx={{ display: "flex", flexDirection: "column", gap: 4 }}>
                  ...
                  <React.Fragment key={subj.id}>
                    ...
                    <Box
                      sx={{
                        ...
                        px: 1.5,
                        py: 1,
                        bgcolor: selectedGrade ? "rgba(62, 57, 123, 0.05)" : idx % 2 === 0 ? "#fff" : "#fafbff",
                    ...
                    >
                      ...
                      >
                        <Typography variant="body2" sx={{ fontWeight: selectedGrade ? 600 : 400, color: "#1a3a52" }}>
                          {subj.name}
                        </Typography>
                        {isCore && (
                          <Chip
      ...
      {formData.hasALevel && (
        <Paper sx={{ p: { xs: 2, sm: 3 }, bgcolor: "#f8fbff", border: "1px solid #e0eef7" }}>
          ...
          <Box sx={{ mt: 1.5, display: "flex", justifyContent: "flex-end" }}>
            <Typography variant="caption" sx={{ fontWeight: 600, color: Object.keys(aGradeMap).length > 0 ? "#2e7d32" : "#666" }}>
