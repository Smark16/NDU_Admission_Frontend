  ...
  return (
    <Box>
      <Stack spacing={3}>
          ...
          <Table>
            ...
            <TableBody>
              {logs.length === 0 ? (
                <TableRow>
                  <TableCell colSpan={7} align="center" sx={{ py: 6 }}>
                    <Typography color="text.secondary">No authentication logs found</Typography>
                  </TableCell>
                </TableRow>
              ) : (
                logs.map((log) => (
                  <TableRow key={log.id} hover>
                    ...
                    <TableCell sx={{ fontWeight: 500 }}>{log.user || "Unknown"}</TableCell>
                    <TableCell>
                      <Chip
                        label={log.action.toUpperCase()}
                        size="small"
                    ...
                    <TableCell sx={{ fontSize: "0.75rem" }}>{log.user_agent || "—"}</TableCell>
        ...
        <Stack direction={{ xs: "column", sm: "row" }} spacing={2} justifyContent="space-between" alignItems="center">
          <Stack direction="row" spacing={1} alignItems="center">
            <Typography variant="body2" color="#6b7280">Rows per page:</Typography>
            <TextField
              select
              size="small"
              value={itemsPerPage}
