...
const navigationItems: NavItem[] = [
...

  {
    ...
    children: [
      ...
      {
        id: "batch-management",
        label: "Batches, courses & registration",
        icon: <Layers size={20} />,
      ...
      {
        id: "admission-change-requests",
        label: "Change Requests",
        icon: <ArrowRightLeft size={20} />,
        path: "/admin/admission-change-requests",
        requiredPermission: "admissions.view_admissionchangerequest",
      },
      {
        id: "faculties",
        label: "Faculties",
...

  {
    ...
    children: [
      ...
      {
        id: "batch-semester-tuition",
        label: "Semester tuition",
        icon: <Layers size={20} />,
        path: "/admin/fees-payments/batch-semester-tuition",
        requiredPermission: "payments.view_applicationfee",
      },
      {
        id: "fee-heads",
        ...
        icon: <Layers size={20} />,
        path: "/admin/fees-payments/fee-heads",
        requiredPermission: "payments.view_feehead",
      },
      {
        id: "finance-overview",
        label: "Finance",
      ...
      {
        id: "tuition-registration",
        label: "Tuition & registration",
        icon: <Receipt size={20} />,
        path: "/admin/tuition_registration",
        requiredPermission: "payments.view_applicationpayment",
      },
    ],
  },
...
export default function Sidebar() {
  const [expandedItems, setExpandedItems] = useState<string[]>(["admissions", "applications", "fees-tuition"])
