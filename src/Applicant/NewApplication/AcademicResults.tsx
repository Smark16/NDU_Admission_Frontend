...
//             Subject Results (Minimum 8 Subjects Required)
//           </Typography>
...
//                         <Select value={subject.subject} onChange={(e) => handleOLevelSubjectChange(subject.id, "subject", e.target.value)}>
...
//               <TextField fullWidth label="A-Level Combination" name="alevel_combination" placeholder="e.g PCM, HEG" value={formData.alevel_combination} onChange={handleInputChange} error={!!formErrors.alevel_combination} helperText={formErrors.alevel_combination} />
//             </Grid>
//           </Grid>
...
//           <Typography variant="subtitle2" sx={{ mb: 2, fontWeight: 600, color: "#5ba3f5" }}>
//             Subject Results (Minimum 5 Subjects Required)
//           </Typography>
...
//                     <TableCell>
//                       <FormControl fullWidth size="small">
//                         <Select value={subject.subject} onChange={(e) => handleALevelSubjectChange(subject.id, "subject", e.target.value)}>
//                           <MenuItem value="">Select Subject</MenuItem>
...
//                   <Select value={qual.type} onChange={(e) => handleAdditionalQualChange(index, 'type', e.target.value as string)} label="Qualification Type">
...
//               </Grid>
//               <Grid size={{ xs: 12, sm: 6 }}>
//                 <TextField fullWidth label="Award Year" type="number" value={qual.year} onChange={(e) => handleAdditionalQualChange(index, 'year', e.target.value)} size="small" />
//               </Grid>
//               <Grid size={{ xs: 12, sm: 6 }}>
//                 <TextField fullWidth label="Class of Award" value={qual.class_of_award} onChange={(e) => handleAdditionalQualChange(index, 'class_of_award', e.target.value)} size="small" />
//               </Grid>
//             </Grid>
//             <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 2 }}>
//               <IconButton color="error" onClick={() => removeAdditionalQualification(index)}>
//                 <DeleteIcon />
//               </IconButton>
//             </Box>
//           </Paper>
...
//       {/* ==================== ADDITIONAL QUALIFICATIONS ==================== */}
//       <Paper sx={{ p: { xs: 2, sm: 3 }, bgcolor: "#f8fbff", border: "1px solid #e0eef7" }}>
//         {/* Show validation error for academic background */}
//         {formErrors.additionalQualifications && (
//           <Alert severity="error" sx={{ mb: 2 }}>
//             {formErrors.additionalQualifications}
//           </Alert>
