              ...
              <TableBody>
                {formData.oLevelSubjects.map((subject) => (
                  <TableRow key={subject.id} sx={{ "&:hover": { bgcolor: "#f5f5f5" } }}>
                    <TableCell>
                      <FormControl fullWidth size="small" required error={!!formErrors.oLevelSubjects}>
                        <Select
                        ...
                        {formErrors.oLevelSubjects && (
                          <FormHelperText>{formErrors.oLevelSubjects}</FormHelperText>
                        )}
                      </FormControl>
                    </TableCell>
                    <TableCell>
            ...
            <Table size="small">
              ...
              <TableBody>
                {formData.aLevelSubjects.map((subject) => (
                  <TableRow key={subject.id} sx={{ "&:hover": { bgcolor: "#f5f5f5" } }}>
                    <TableCell>
                      <FormControl fullWidth size="small" required error={!!formErrors.aLevelSubjects}>
                        <Select
                          value={subject.subject}
                        ...
                        {formErrors.aLevelSubjects && (
                          <FormHelperText>{formErrors.aLevelSubjects}</FormHelperText>
                        )}
                      </FormControl>
                    </TableCell>
                    <TableCell>
