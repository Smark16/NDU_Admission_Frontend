...
//     const subjectIds = formData.oLevelSubjects
//       .map((s: SubjectResult) => s.subject)
//       .filter(Boolean);
...
//     const subjectIds = formData.aLevelSubjects
//       .map((s: SubjectResult) => s.subject)
//       .filter(Boolean);
//     const countMap = new Map();
//     subjectIds.forEach((id:any) => countMap.set(id, (countMap.get(id) || 0) + 1));
...
//             Duplicate O-Level subjects detected. Please remove duplicates.
//           </Alert>
//         )}
...
//                   <TableCell>
//                     <FormControl fullWidth size="small" error={oLevelDuplicates.has(subject.subject)}>
//                       <Select
...
//           <Alert severity="error" sx={{ mb: 2 }}>
//             Duplicate A-Level subjects detected. Please remove duplicates.
//           </Alert>
//         )}
...
//                 <TableRow key={subject.id} sx={{ "&:hover": { bgcolor: "#f5f5f5" } }}>
//                   <TableCell>
//                     <FormControl fullWidth size="small" error={aLevelDuplicates.has(subject.subject)}>
//                       <Select
//                         value={subject.subject}
...
//           <Paper key={index} sx={{ p: { xs: 2, sm: 3 }, mb: 3, border: '1px solid #e0e0e0', borderRadius: 2 }}>
...
//               <IconButton color="error" onClick={() => removeAdditionalQualification(index)} size="small">
//                 <DeleteIcon />
//               </IconButton>
//             </Box>
//           </Paper>
  ...
  return (
    <Box sx={{ display: "flex", flexDirection: "column", gap: 4 }}>
      ...
      <Paper sx={{ p: { xs: 2, sm: 3 }, bgcolor: "#f8fbff", border: "1px solid #e0eef7" }}>
        ...
        {/* O-Level Subjects Error Message */}
        {formErrors.oLevelSubjects && (
          <Alert severity="error" sx={{ mb: 2 }}>
            {formErrors.oLevelSubjects}
          </Alert>
        )}
      ...
      <Paper sx={{ p: { xs: 2, sm: 3 }, bgcolor: "#f8fbff", border: "1px solid #e0eef7" }}>
        ...
        {/* A-Level Subjects Error Message */}
        {formErrors.aLevelSubjects && (
          <Alert severity="error" sx={{ mb: 2 }}>
            {formErrors.aLevelSubjects}
          </Alert>
        )}
